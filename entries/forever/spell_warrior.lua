...
-- Booming Voice
[12321] = { "Гулкий голос", "Збільшує радіус дії \"Бойового кличу\" та \"Деморалізуючого кличу\" на {1}%.#abilities by {1}%", en="Booming Voice" },
...
-- Cruelty
[12320] = { "Жорстокість", "Збільшує ймовірність завдати критичного удару атаками ближнього бою на {1}%.#critical strike with melee attacks by {1}%", en="Cruelty" },
...
-- Talents present in the current Forever trait tree.
[29787] = { "Зосереджена лють", "Зменшує витрати люті на атакувальні здібності на {1}.#abilities by {1}", en="Focused Rage" },
[1225295] = { "Влучність", "Збільшує ймовірність влучити на {1}%.#hit by {1}%", en="Precision" },
[1289682] = { "Кривавий азарт", "Атаки ближнього бою основною рукою по ворогах під дією вашого «Розриву» з ймовірністю {1}% дають змогу застосувати до цілі «Здолання». Триває {2} с.#have a {1}% chance#Lasts {2}", en="Bloodthrill" },
[1290261] = { "Майстер зброї", "Атаки зброєю ближнього бою отримують бонус залежно від зброї.|n|n|CFFFFFFFFСокира/держакова зброя:|R збільшує ймовірність критичного удару на {1}%.|n|CFFFFFFFFБулава/посох:|R атаки ігнорують {2}% броні цілі.|n|CFFFFFFFFМеч:|R успішні атаки ближнього бою з ймовірністю {3}% спричиняють додаткову атаку по цілі.#critical strike chance by {1}%#{2}% of your target's armor#attacks have a {3}% chance", en="Weaponmaster" },
[1310222] = { "Проколювальний удар", "Жорстокий удар, що завдає {1}% шкоди зброєю. Велетням, драконідам і вершникам завдає додатково {2}% шкоди зброєю. Вершників збиває з сідла.#deals {1}% weapon damage#additional {2}% weapon damage", en="Spearing Strike" },
[1310236] = { "Безмежна лють", "Збільшує максимальний запас люті на {1}.#maximum Rage by {1}", en="Boundless Rage" },
[1310315] = { "Люті удари", "«Вихор» також завдає удару зброєю з другої руки, а витрати люті на «Розсічення» зменшуються на {1}.#Cleave ability by {1}", en="Raging Blows" },
[1310316] = { "Майстер захисту", "Дає {1}% ймовірності отримати {2} од. люті під час ухилення або парирування зі щитом у руках.#a {1}% chance to generate {2} Rage", en="Master of Defense" },
[1310317] = { "Авангард", "«Ривок» тепер можна застосовувати в захисній стійці.", en="Vanguard" },
